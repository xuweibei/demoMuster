...
class ProductPriceList extends React.Component {
  ...
  fetch(params = {}) {
    ...
    this.props.recruitProductPriceListDQ(condition).payload.promise.then((response) => {
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    recruitProductPriceListDQ: bindActionCreators(recruitProductPriceListDQ, dispatch),
  };
}
//redux 组件 封装
