...
import { message, Form, Row, Col, Table, DatePicker,} from 'antd';
...
import { getChangeDetailMoveInfoList } from '@/actions/course';
...
class ChangeDetailInfo extends React.Component {
    ...
    fetch(params) {
        ...
        this.props.getChangeDetailMoveInfoList(condition).payload.promise.then((response) => {
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        getChangeDetailMoveInfoList: bindActionCreators(getChangeDetailMoveInfoList, dispatch),
    };
}
//redux 组件 封装
