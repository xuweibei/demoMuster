    ...
    break; 
      ...
      default:
        ...
        extendButtons.push(<Button className='ant-btn-primary changeButton'  onClick={() => {
          ...
          // this.onSearch();
          this.setState({press:'columns'});
        }} icon="search">按分部</Button>);
        extendButtons.push(<Button  className='changeButton' onClick={() => {
          this.onShowSizeChange('l',10)
          // this.onSearch();
          this.setState({press:'customerColumns'});
        }} icon="search">按大客户</Button>);
        extendButtons.push(<Button className='changeButton' onClick={() => {
          this.onShowSizeChange('l',10)
          // this.onSearch();
          this.setState({press:'universitiesColumns'});
        }} icon="search">按高校</Button>);
        extendButtons.push(<Button className='changeButton' onClick={() => {
          this.onShowSizeChange('l',10)
          // this.onSearch(); 
          this.setState({press:'campusColumns'});
        }} icon="search">按高校校区</Button>);
        extendButtons.push(<Button className='changeButton' onClick={() => {
          this.onShowSizeChange('l',10)
          // this.onSearch();
          this.setState({press:'projectColumns'});
        }} icon="search">按项目</Button>);
        extendButtons.push(<Button className='changeButton' onClick={() => {
          this.onShowSizeChange('l',10)
          // this.onSearch();
          this.setState({press:'typeColumns'});
        }} icon="search">按班型</Button>); 
        block_content = (
          <div>
            {/* 搜索表单 */}
              ...
              {!this.state.seachOptionsCollapsed &&
                <Form className="search-form" >
                  <Row gutter={24}>
                    ...
                    <Col span={12}>
                      {this.state.press=='columns'?<FormItem {...searchFormItemLayout} label="分部" >
            ...
            <div className="search-result-list">
              ...
              <div className="search-paging">
                ...
                <Col span={24} style={{paddingBottom:'20px'}}>
                      ...
                      <FileDownloader
                        apiUrl={'/edu/orderPreCharge/exportPreChargeListByFee'}//api下载地址
                        method={'post'}//提交方式
                        options={this.state.pagingSearch}//提交参数
                        title={'导出缴费/退费学生明细'}
                      >
