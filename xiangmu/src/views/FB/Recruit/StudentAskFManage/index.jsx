...
import { message, Form, Row, Col, Input, Select, Button, Icon, Table, Pagination, Divider, InputNumber, DatePicker,Modal } from 'antd';
...
//业务数据视图（增、删、改、查)
import ByStudentId from '../StudentAskFManage/byStudentId.jsx';
//import ItemView from '../ItemView';
import ContentBox from '@/components/ContentBox';
import SelectArea from '@/components/BizSelect/SelectArea';
import DropDownButton from '@/components/DropDownButton';
import DaoRuF from '../StudentAskFManage/daoRuF.jsx';
...
class StudentAskFManage extends React.Component {
    ...
    columns = [
        ...
        },
        {
            ...
            render: (text, record, index) => {
                return record.numberOfDaysAgo<0?0:record.numberOfDaysAgo
            },
        },
        {
            title: '操作',
            ...
            render: (text, record) => {
                return <DropDownButton>
                    <Button onClick={() => { this.onLookView('ByStudentId', record) }}>编辑面咨</Button>
    ...
    render() {
        ...
        switch (this.state.editMode) {
            ...
            case "ByStudentId":
                ...
                break;
            case "DaoRuF":
                block_content = <DaoRuF viewCallback={this.onViewCallback} {...this.state} />
                break;
            ...
            default:
                ...
                //除查询外，其他扩展按钮数组
                let extendButtons = [];
                extendButtons.push(<Button icon="download" onClick={() => { this.onLookView('DaoRuF', {}) }} className="button_dark">
                    导入面咨信息</Button>);
                        ...
                        {!this.state.seachOptionsCollapsed &&
                            <Form className="search-form" >
                                ...
                                <Row justify="center" gutter={24} align="middle" type="flex">
                                    ...
                                    <Col span={12} >
                                        <FormItem {...searchFormItemLayout} label={'？天内未面询'} >
