...
import { ExclusiveStudentApplicationList,BonusPayment } from '@/actions/stuService'; 
...
class ExclusiveUniformManagement extends React.Component {
        ...
        fetch = (params = {}) => { 
            ...
            this.props.ExclusiveStudentApplicationList(condition).payload.promise.then((response) => {
...
function mapDispatchToProps(dispatch){
    return {
        ...
        //列表
        ExclusiveStudentApplicationList: bindActionCreators(ExclusiveStudentApplicationList, dispatch),
