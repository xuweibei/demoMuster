...
import { getByItemOrg, editByItemOrg, queryDiscountPriceByItemId } from '@/actions/recruit';
  ...
  columns = [
    ...
    },
    {
      ...
      render: (text, record, index) => {
        ...
        return <InputNumber value={record.discountPrice} max={this.state.maxDiscountPrice} onChange={(value) => {
        ...
        <Col span={16}>
          ...
          >
            {getFieldDecorator('discountPrice', {
              ...
              <InputNumber max={this.state.maxDiscountPrice} min={0}/>
              )}<Button onClick={this.onEditDiscountPrice} icon="tool" style={{marginLeft:10}}>统一设置</Button><br/> （大区限额（¥）：{this.state.maxDiscountPrice}）
          </FormItem>
        </Col>
      </Row>
    </Form>
