...
class ProductPriceApplyList extends React.Component {
  ...
  componentWillMount() {
    //载入需要的字典项: 
    this.loadBizDictionary(['dic_Status', 'product_branch_price_status', 'producttype', 'dic_Allow','teachMode','class_type_type','category_scope']);
  ...
  fetch(params = {}) {
    ...
    this.props.selectByFProductPriceZorD(condition).payload.promise.then((response) => {
    ...
    switch (this.state.editMode) {
      ...
      default:
        ...
        extendButtons.push(<FileDownloader
          apiUrl={'/edu/productPrice/exportByFProductPriceZorD'}//api下载地址
          method={'post'}//提交方式
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    selectByFProductPriceZorD: bindActionCreators(selectByFProductPriceZorD, dispatch),
  };
}
//redux 组件 封装
