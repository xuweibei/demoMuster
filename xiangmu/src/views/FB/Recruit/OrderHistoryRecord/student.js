    ...
    render() {
      ...
      if(this.props.editMode == 'CreateByOrderCreate'
        ...
        var _list = [
          ...
          {type: 'input', title: 'QQ'     , name: 'qq', required: false, value: this.state.dataModel.qq},
          {type: 'input', title: '微信'   , name: 'weixin', required: false, value: this.state.dataModel.weixin},
          {type: 'input', title: '紧急联系人姓名', name: 'emergencyContactName', required: false, value: this.state.dataModel.emergencyContactName},
          {type: 'input', title: '紧急联系人电话', name: 'emergencyContactPhone', required: false, value: this.state.dataModel.emergencyContactPhone},
          {type: 'select', title: '与紧急联系人关系', name: 'emergencyContactType', data: 'contact_type', required: false, value: this.state.dataModel.emergencyContactType},
