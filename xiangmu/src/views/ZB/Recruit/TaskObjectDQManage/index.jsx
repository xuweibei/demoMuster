...
//业务接口方法引入
import { taskObjectDQManageList, taskObjectDQManageAddOrUpdate } from '@/actions/recruit';
//业务数据视图（增、删、改、查)
import TaskObjectDQView from '../TaskObjectDQView';
...
class TaskObjectDQManage extends React.Component {
    ...
    fetch = (params = {}) => {
        ...
        this.props.taskObjectDQManageList(condition).payload.promise.then((response) => {
    ...
    render() {
        ...
        switch (this.state.editMode) {
            ...
            case "BtchEdit":
            case "View":
                block_content = <TaskObjectDQView
                                ...
                                <Row justify="center" gutter={24} align="middle" type="flex">
                                    ...
                                    <Col span={12}>
                                        <FormItem {...searchFormItemLayout} label={'大区'} >
                                            {getFieldDecorator('regionName', { initialValue: this.state.pagingSearch.regionName })(
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        //各业务接口
        taskObjectDQManageList: bindActionCreators(taskObjectDQManageList, dispatch),
