    ...
    switch (this.state.editMode) {
      ...
      default:
        ...
        var rowSelection = {
          ...
          //     disabled: fas,    // Column configuration not to be checked
          //   })
          // },
        };
                    ...
                    <Col span={12} >
                      ...
                      >
                         {getFieldDecorator('activeStartTime', { 
                            initialValue: this.state.pagingSearch.activeStartTime?(this.state.pagingSearch.activeEndTime?[moment(this.state.pagingSearch.activeStartTime, dateFormat),moment(this.state.pagingSearch.activeEndTime, dateFormat)]:[moment(this.state.pagingSearch.activeStartTime, dateFormat)]):'',
                            rules: [
            ...
            <div className="search-result-list">
              ...
              <div className="search-paging">
                <Row justify="space-between" align="middle" type="flex">
                  <Col span={24}> 
                      {
                        this.state.UserSelecteds.length?<Button loading={this.state.loading} icon="rocket" onClick={this.BatchSetup}>批量设置</Button> :<Button loading={this.state.loading} icon="rocket" disabled>批量设置</Button>
                      } 
                      ...
                      <div className='split_button' style={{ width: 10 }}></div>
                      <Button loading={this.state.loading} icon="rocket" onClick={this.BatchImport}>批量导入</Button> 
                  </Col>
                </Row>
