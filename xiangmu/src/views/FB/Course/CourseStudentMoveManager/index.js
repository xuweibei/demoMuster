...
import { getCourseStudentMoveManagerList, deleteCourseStudentMoveManager } from '@/actions/course';
...
//业务数据视图（增、删、改、查)
import CourseStudentMoveManagerView from './view'

class CourseStudentMoveManager extends React.Component {
    ...
    fetch(params) {
        ...
        this.props.getCourseStudentMoveManagerList(condition).payload.promise.then((response) => {
    ...
    render() {
        ...
        switch (this.state.editMode) {
            ...
            case "Edit":
            case "View":
                block_content = <CourseStudentMoveManagerView viewCallback={this.onViewCallback}
...
//表单组件 封装
const WrappedManage = Form.create()(CourseStudentMoveManager);
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        getCourseStudentMoveManagerList: bindActionCreators(getCourseStudentMoveManagerList, dispatch),
        deleteCourseStudentMoveManager: bindActionCreators(deleteCourseStudentMoveManager, dispatch),
    };
}
//redux 组件 封装
