...
import { ShareOpportunityList,ShareOpportunityPreservation,OutGoingTaskBatchArrive,OutGoingTaskBatcNohArrive } from '@/actions/base'; 
...
class StudentInviteManage extends React.Component {
  ...
  fetch = (params = {}) => {
    ...
    console.log(condition ,params,this.state.pagingSearch)
    //日期
                  ...
                  <Row justify="center" gutter={24} align="middle" type="flex">
                    ...
                    <Col span={12} >
                      <FormItem
                        ...
                        label="预约日期"
                      >
                        {getFieldDecorator('inviteDateStart', { initialValue: this.state.pagingSearch.studentCreateDateStart?[moment(this.state.pagingSearch.studentCreateDateStart,dateFormat),moment(this.state.pagingSearch.studentCreateDateEnd,dateFormat)]:[] })(
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    ShareOpportunityList: bindActionCreators(ShareOpportunityList, dispatch),//列表查询
    ShareOpportunityPreservation: bindActionCreators(ShareOpportunityPreservation, dispatch),//共享机会编辑保存
