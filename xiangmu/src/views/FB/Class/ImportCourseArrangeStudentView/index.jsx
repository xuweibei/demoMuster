...
class ImportCourseArrangeStudentView extends React.Component {
  ...
  onSave = () => {
    ...
    formData.append('courseplanBatchId',this.props.currentCoursePlanBatch.value);
    formData.append('courseArrangeId',this.props.currentDataModel.courseArrangeId);
    ...
    const successFn = (response) => {
      ...
      if (data.state == 'success') {
        ...
        that.setState({
          ...
          error_url: `/edu/courseArrangeStudent/exportWrongStudent`,
        })
        //param.success({
    ...
    let uploadUrl = `${env.serverURL}/edu/courseArrangeStudent/importExcel?token=${token}`;
    const xhr = new XMLHttpRequest
              ...
              <Row gutter={24}>
                ...
                <Col span={12}>
                  <FormItem {...searchFormItemLayout} label="课程班类型">
                    {getDictionaryTitle(this.state.teach_class_type, this.props.currentDataModel.teachClassType)}
                  </FormItem>
                </Col>
