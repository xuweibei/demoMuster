...
viewCallback [回调]
*/
class TaskObjectDQView extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    onSubmit = () => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                this.props.viewCallback({orgType: 2, feeKpis: JSON.stringify(params)});
            }
        });
    }
...
const WrappedTaskObjectDQView = Form.create()(TaskObjectDQView);
...
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedTaskObjectDQView);
