...
import {
  recruitProductPriceList, recruitProductPriceExport
...
class ProductPriceList extends React.Component {
  ...
  componentWillMount() {
    //载入需要的字典项: 
    this.loadBizDictionary(['dic_Status', 'producttype', 'dic_Allow']);
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    recruitProductPriceExport: bindActionCreators(recruitProductPriceExport, dispatch),
  };
}
//redux 组件 封装
