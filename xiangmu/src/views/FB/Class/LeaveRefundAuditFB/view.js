                ...
                block_content = (
                    <Form>
                        <Row gutter={24}>
                            ...
                            {
                                this.state.dataModel.changeTypeName == '退费' ? <Col span={24}>
                                    <FormItem {...searchFormItemLayout24} label="匹配新订单">
                                    <a onClick={() => {
                            ...
                            <Row gutter = {24}>
                                ...
                                <Col span={12}>
                                    <FormItem {...searchFormItemLayout} label="订单归属">
                                        {this.state.DetailsMain.benefitRegionName}
                                    </FormItem>
                                </Col>
                                <Col span={12}>
                                    <FormItem {...searchFormItemLayout} label="学生归属">
                                        {this.state.DetailsMain.studentRegionName}
                                    </FormItem>
                                </Col>
                                <Col span={12}>
                                ...
                                <Col span={24}>
                                    <FormItem {...searchFormItemLayout24} label="退费订单转入缴费金额(￥)">
                                        {this.state.DetailsMain.paidAmount}
                                    </FormItem>
                                </Col>
