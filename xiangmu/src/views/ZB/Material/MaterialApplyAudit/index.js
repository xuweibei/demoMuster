...
class MaterialApplyAudit extends React.Component {
  state= {
    editMode: '',
    pagingSearch: {
      currentPage: 1,
  ...
  componentWillMount(){
    this.loadBizDictionary(['dic_YesNo','product_partner_price_status']);
    this.onSearch();
  }
...
//表单组件 封装
const WrappedManage = Form.create()(MaterialApplyAudit);
