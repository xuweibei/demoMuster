...
viewCallback [回调]
*/
class AskPView extends React.Component {
    constructor(props) {
        super(props)
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                this.props.viewCallback({
                    ...
                    createUid: this.state.dataModel.benefitPconsultUserId,
                    askSource: 1,
                    askType: 1,
            ...
            case "Edit":
                block_content = (
                    <Form>
                        ...
                        <Row justify="center" gutter={24} align="middle" type="flex">
                            <Col span={12}>
                                <FormItem {...searchFormItemLayout} label={'电咨日期'} >
                                    {getFieldDecorator('askDate', {
                                        initialValue: dataBind(timestampToTime(this.state.data_ask.askDate), true),//
                                        rules: [{
                                            required: true, message: '请选择电咨日期!',
                                        }],
                                    })(
                                        <DatePicker format={dateFormat} placeholder='电咨日期'
...
const WrappedAskPView = Form.create()(AskPView);
