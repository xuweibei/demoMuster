                ...
                block_content = (
                    <Form>
                        <Row gutter={24}>
                            ...
                            {
                                this.state.dataModel.changeTypeName =='退费' ? 
                                <Col span={12}>
                                    <FormItem {...searchFormItemLayout} label="匹配新订单">
                                    <a onClick={() => {
                                            this.setState({ orderNum: true,mange:true,isNew:true })
                                        }}>{formatMoney(this.state.dataModel.productAddRefundAmount)}</a>
                                        &nbsp;&nbsp;&nbsp;
                                    <a onClick={() => {
                                            this.setState({ details: true,mange:true })
                                        }}
                                        >查看课程明细</a>
                                    </FormItem>
                                </Col>:''
                    ...
                    <div className="dv_split"></div>
                        <Form className ='search-from'>
                            <Row gutter = {24}>
                                ...
                                <Col span={24}>
                                    <p style={{paddingLeft:20,paddingBottom:10,fontWeight:"bold"}}>退费订单转入缴费金额(￥):</p>
                                </Col>
                                <Col span={12}>
