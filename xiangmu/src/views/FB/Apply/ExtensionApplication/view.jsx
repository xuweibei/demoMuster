      ...
      if (!err) {
        ...
        if (this.props.editMode == 'Edit') {
          var postData = {
           ...
           values.studentInviteIds = this.state.studentInviteIds
        }
        else {
          var postData = {
        ...
        block_content = (
          <Form className="search-form">
             <p style={{marginLeft:'10%',fontSize:16,color:'black'}}>
                   您对学生<span style={{color:'red',margin:'0 10'}}>{this.state.arriveMan}</span>进行到访反馈：
             </p>
            <Row gutter={24}>
            <Col span={24}>
                <FormItem
