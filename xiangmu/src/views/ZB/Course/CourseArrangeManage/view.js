...
class CourseArrangeDetailEdit extends React.Component {
    ...
    render() {
        let a =  this.state.dataModel.timeQuantum == '09:00-13:00'?0:1;
                  ...
                  <Row gutter={24}>
                    <Col span={12}>
                      <FormItem {...searchFormItemLayout} label="上课时段标准">
                          <Select value={
                            this.timeView()
                            // this.state.dataModel.timeQuantum == '09:00-13:00'?
                            // 2:this.state.dataModel.timeQuantum == '14:00-18:00'?
                            // 3:this.state.dataModel.timeQuantum == '18:00-21:30'?
                            // 4:this.state.dataModel.timeQuantum == '09:00-18:00'?1:0
