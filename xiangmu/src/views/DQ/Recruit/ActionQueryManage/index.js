  ...
  columns = [
    ...
    },
    {
      ...
      render: (text, record, index) => {
        return <a onClick={() => { this.onLookView('View', { ...record, activityTypeName: getDictionaryTitle(this.state.activity_type, record.activityType) }) }}>{record.activityName}</a>
      }
    },
                    ...
                    <Col span={12} >
                      ...
                      >
                        ...
                        <div className='dv_col2'>
                          {this.state.isUniversity && getFieldDecorator('universityId', { initialValue: dataBind(this.state.pagingSearch.universityId) })(
                            <SelectUniversity />
                          )}</div>
                      </FormItem>
                    </Col>
