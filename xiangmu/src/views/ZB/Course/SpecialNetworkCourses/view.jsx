...
import {searchFormItemLayout,searchFormItemLayout24,renderSearchBottomButtons,onSearch} from '@/utils/componentExt';
  ...
  render() {
    ...
    return (
      ...
      <div className="space-default"></div>
          ...
          <Button onClick={this.BatchSetUp} style={{marginLeft:'52%',marginTop:-74}}>批量设置</Button>
          </div>
          
          <Button onClick={this.onStudentView}>确定开通</Button>
      </div>:
