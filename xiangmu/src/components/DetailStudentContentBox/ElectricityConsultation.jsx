...
import { qryByStudentId} from '@/actions/recruit';
//业务数据视图（增、删、改、查)
import ContentBox from '@/components/ContentBox';


class ElectricityConsultation extends React.Component {
    ...
    fetch = () => {
        ...
        this.props.qryByStudentId({studentId:this.props.studentId,askType:1}).payload.promise.then((response) => {
    ...
    render() {
        ...
        let block_content_1 =
            <ContentBox titleName='电咨情况' hideBottomBorder={false}>
...
//表单组件 封装
const WrappedElectricityConsultation = Form.create()(ElectricityConsultation);
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        qryByStudentId: bindActionCreators(qryByStudentId, dispatch),//根据学生id查询电咨情况
    };
}
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedElectricityConsultation);
