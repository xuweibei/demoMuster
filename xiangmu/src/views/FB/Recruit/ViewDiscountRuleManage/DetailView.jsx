            ...
            <Row gutter={24}>
              ...
              <Col span={12} >
                <FormItem
                  ...
                  label="优惠金额（¥）"
                >
                {this.state.dataModel.productDiscountType==1?(formatMoney(this.state.dataModel.productDiscountPrice)/10).toFixed(1)+'折':formatMoney(this.state.dataModel.productDiscountPrice)}
                </FormItem>
              </Col>
              <Col span={12}>
                <FormItem
              ...
              <Col span={24}>
                <FormItem
                  ...
                  label="适用商品"
                >
                  {this.state.dataModel.fitProductNames}
                </FormItem>
              </Col>
              <Col span={24}>
                <FormItem
