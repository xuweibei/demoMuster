...
class CourseArrangeImportPage extends React.Component {
  ...
  onSave = () => {
    ...
    formData.append('courseId', this.props.currentDataModel.courseId);
    ...
    const successFn = (response) => {
      ...
      if (data.state == 'success') {
        ...
        that.setState({
          ...
          error_url: `/edu/specialOnlineCourseImport/exportError`,
        })
        //param.success({
    ...
    let uploadUrl = `${env.serverURL}/edu/specialOnlineCourseImport/import?token=${token}`;
    const xhr = new XMLHttpRequest
              ...
              <Row gutter={24}>
                ...
                <Col span={24}>
                  ...
                  <FileDownloader
                    ...
                    method={'post'}//提交方式
                    options={{ filePath: 'upload/importTemplate/specialOnlineCourseImport.xlsx' }}
                    title={'下载上传模板'}
    ...
    return (
      <ContentBox titleName={"课表导入"} bottomButton={
        <FormItem
          ...
          {...btnformItemLayout}
        >
          <Button type="primary" loading={this.state.loading} icon="save" onClick={this.onSave}>导入</Button>
