...
class AreaDiscountRuleManage extends React.Component {
  ...
  fetch = (params = {}) => {
    ...
    if(startDate){
      condition.startDate = startDate[0];
      condition.endDate = startDate[1];
    }
  ...
  render() {
    ...
    switch (this.state.editMode) {
      ...
      default:
        ...
        } icon="plus" className="button_dark" > 新增分部限额</Button>);
                ...
                <Row justify="space-between" align="middle" type="flex">
                  <Col span={6}>
                    {this.state.UserSelecteds.length > 0 ?
                      <Button onClick={this.onBatchAudit} icon="edit">批量修改限额</Button> :
