...
viewCallback [回调]
*/
class StudentAskBenefitView extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
  ...
  getTitle() {
    ...
    if (this.props.editMode == 'editmUser') {
      ...
      // }
      op = getViewEditModeTitle(this.props.editMode);
      return `批量修改${this.props.UserSelecteds.length}修改市场人员`;
    }
    if (this.props.editMode == 'editpUser') {
      op = getViewEditModeTitle(this.props.editMode);
      return `批量修改${this.props.UserSelecteds.length}修改电咨人员`;
    }
    if (this.props.editMode == 'editfUser') {
      op = getViewEditModeTitle(this.props.editMode);
      return `批量修改${this.props.UserSelecteds.length}修改面咨人员`;
    }
...
const WrappedStudentAskBenefitView = Form.create()(StudentAskBenefitView);
...
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedStudentAskBenefitView);
