...
class StudentAskfaceManage extends React.Component {
...
onEndChange = (value) => {
  ...
  columns = [
    ...
    {
      title: '分配面咨日期',
      dataIndex: 'benefitFconsultDate',
      render: (text, record, index) => (`${timestampToTime(record.benefitFconsultDate)}`)
    },
    {
      title: '最新面咨日期',
      dataIndex: 'askDate',
              ...
              {!this.state.seachOptionsCollapsed &&
                ...
                >
                  <Row justify="center" gutter={24} align="middle" type="flex">
                    ...
                    <Col span={8}>
                      <FormItem {...searchFormItemLayout} label={'?天内未面咨'} >
                    ...
                    <Col span={8}>
                      <FormItem {...searchFormItemLayout} label={'分配面咨情况'} >
                ...
                <Row justify="end" align="middle" type="flex">
                  <Col span={4}>
                      {(this.state.data.length > 0 && this.state.UserSelecteds.length > 0) ?
                        <Button onClick={this.oneditpUser} icon='editpUser'>面咨人员调整</Button> :
                        <Button disabled icon='editpUser'>面咨人员调整</Button>
                      }
                    </Col>
...
//表单组件 封装
const WrappedManage = Form.create()(StudentAskfaceManage);
