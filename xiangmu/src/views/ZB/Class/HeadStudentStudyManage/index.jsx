...
import { ZBheadquarterStudentStudyList } from '@/actions/enrolStudent';
//业务数据视图（增、删、改、查)
...
class HeadStudentStudyManage extends React.Component {
    ...
    fetch = (params = {}) => {
        ...
        this.props.ZBheadquarterStudentStudyList(condition).payload.promise.then((response) => {
                                        ...
                                        <FormItem {...searchFormItemLayout} label="请选择分部教学点">
                                            {
                                                getFieldDecorator('teachCenterId', {
                                                    initialValue: '',
                                                    rules: [{
                                                        required: false, message: '请选择分部教学点!',
                                                    }],
                                                })
                                                    (
...
//表单组件 封装
const WrappedCourseManage = Form.create()(HeadStudentStudyManage);
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        ZBheadquarterStudentStudyList: bindActionCreators(ZBheadquarterStudentStudyList, dispatch),
    };
}
//redux 组件 封装
