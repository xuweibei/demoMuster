...
import { getUniversityByBranchId } from '@/actions/base';//全部高校列表（不受数据范围限制）

const Option = AutoComplete.Option;
//value=[{id,name},{id,name}]
class ZBEditableAllUniversityTagGroup extends React.Component {
    input = null
    constructor(props) {
        super(props)
        //扩展方法用于本组件实例
...
export default connect(mapStateToProps, mapDispatchToProps)(ZBEditableAllUniversityTagGroup);
