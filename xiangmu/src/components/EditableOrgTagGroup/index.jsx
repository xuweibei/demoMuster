...
import { orgBranchList } from '@/actions/admin';
//value=[{id,name},{id,name}]
class EditableOrgTagGroup extends React.Component {
    input = null
    constructor(props) {
        super(props)
        console.log(props)
    ...
    handleSearch = (value) => {
        ...
        this.props.orgBranchList('', value).payload.promise.then((response) => {
    ...
    render() {
        ...
        return (
            <div>
                ...
                {!inputVisible && this.state.tags.length < this.state.maxTags && <Button size="small" type="dashed" onClick={this.showInput}>+ 分部</Button>}
            </div>
        );
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(EditableOrgTagGroup);