...
class ConsultativeSituation extends React.Component {
    ...
    fetch = () => {
        ...
        this.props.qryByStudentId({studentId:this.props.studentId,askType:2}).payload.promise.then((response) => {
    ...
    render() {
        ...
        let block_content_1 =
            <ContentBox titleName='面咨情况' hideBottomBorder={false}>
...
//表单组件 封装
const WrappedConsultativeSituation = Form.create()(ConsultativeSituation);
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        qryByStudentId: bindActionCreators(qryByStudentId, dispatch),//根据学生id查询面咨情况
    };
}
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedConsultativeSituation);
