    ...
    },
    {
        ...
        render: (text, record) => {
            return <DropDownButton>
                ...
                {record.statusNum == 3 && <Button onClick={() => {
                    this.props.getCourseStudentRefundCheckStudentChange({ studentChangeId: record.studentChangeId,auditOrgType:2 }).payload.promise.then((response) => {
                                            ...
                                            <FormItem {...searchFormItemLayout} label="审核状态">
                                                {getFieldDecorator('status', {
                                                    ...
                                                    <Select >
                                                        ...
                                                        {this.state.student_change_refund_status_front.filter(item=> item.value!=1 && item.value!=2 ).map((item, index) => { 
