...
import { HighSeasStudentInquiryList} from '@/actions/recruit'; 
//业务数据视图（增、删、改、查) 
...
class StudentManage extends React.Component {
    ...
    componentWillMount() {
        ...
        this.loadBizDictionary(['dic_Status', 'sex', 'is_study','dic_YesNo']);
    ...
    fetch = (params) => {
        ...
        this.props.HighSeasStudentInquiryList(condition).payload.promise.then((response) => {
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        //各业务接口
        HighSeasStudentInquiryList: bindActionCreators(HighSeasStudentInquiryList, dispatch),//列表查询接口 
