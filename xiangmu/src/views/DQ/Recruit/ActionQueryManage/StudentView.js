...
import { getDQParticipateStudentList, postRecruitBatchList } from '@/actions/recruit';
...
class StudentView extends React.Component {
  ...
  fetch = (params = {}) => {
    ...
    this.props.getDQParticipateStudentList(condition).payload.promise.then((response) => {
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    getDQParticipateStudentList: bindActionCreators(getDQParticipateStudentList, dispatch),
