...
class TeachingStudentQuery  extends React.Component {
  ...
  componentWillMount() {
    //载入需要的字典项
    this.loadBizDictionary(['teach_class_type','teachmode', 'study_status','order_type','payee_type','order_source','order_status']);//课程班类型
    //首次进入搜索，加载服务端字典项内容
    // this.onSearch();
  }
              ...
              <Row gutter={24}  type="flex">
                ...
                <Col span={12} >
                  <FormItem
                    ...
                    label="创建日期"
                  >
                    {getFieldDecorator('startDate', { initialValue: this.state.pagingSearch.startDate })(
