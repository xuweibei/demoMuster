...
class StudentHistoryManage extends React.Component {
    ...
    onBatchDelete = () => {
        ...
        Modal.confirm({
            ...
            onOk: () => {
                this.props.deleteByPrimaryKeyForBatch({ ids: studentIdslist.join(","), type: 'old' }).payload.promise.then((response) => {
                    let data = response.payload.data;
            ...
            default:
                ...
                var rowSelection = {
                    ...
                    getCheckboxProps: record => ({
                        disabled: this.props.currentDataModel.isStart || record.reserveLiveCount > 0,    // Column configuration not to be checked
                    }),
                };
                block_content = (<div>
                    {/* 搜索表单 */}
