...
import { getChangeDetailInfoList } from '@/actions/course';
...
class ChangeDetailInfo extends React.Component {
    ...
    componentWillMount() {
        //载入需要的字典项: 审核状态
        this.loadBizDictionary(['dic_YesNo','zb_payee_type','payee_type']);
        //首次进入搜索，加载服务端字典项内容
        this.onSearch();
    }
    ...
    fetch(params) {
        ...
        this.props.getChangeDetailInfoList(condition).payload.promise.then((response) => {
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        getChangeDetailInfoList: bindActionCreators(getChangeDetailInfoList, dispatch),
    };
}
//redux 组件 封装
