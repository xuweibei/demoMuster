...
class ExclusiveUniformManagement extends React.Component {
        ...
        //         content: '',
        //         onOk() {
        //             that.props.BatchSubmissionForDelete({goodStudentIds:that.state.UserSelecteds.join(',')}).payload.promise.then((response) => {
        //                 let data = response.payload.data;  
        //                     if(data.state == 'success'){
        //                         message.success('删除成功！')
        //                         this.setState({
                                    ...
                                    <Row gutter = {24} type='flex'>
                                        ...
                                        <Col span={8}>
                                            ...
                                            {getFieldDecorator('teachCenterId', { initialValue: this.state.pagingSearch.teachCenterId })(
                                                <SelectTeachCenterByUser branchId = {this.state.branchId} onChange={(value)=>{this.ChangesTeachingPoints(value)}}/>
                                            )}
                                            </FormItem>
                                        </Col> 
                                        <Col span={8}>
