...
class EditableCourseName extends React.Component {
    input = null
    constructor(props) {
        super(props)
        //扩展方法用于本组件实例
        ...
        if (value) {
            ...
            if (value.length < 3) { //返回中文的个数
                ...
                let params = {
                    ...
                    courseCategoryId: this.props.courseCategoryId || '',
                }
                this.props.getCourseList(params).payload.promise.then((response) => {
                    ...
                    if (data.state === 'success') {
                        this.setState({
                            dataSource: data.data.map((a) => {
                                ...
                                return { id: `${a.courseId}`, name: `${a.courseName}` }
...
export default connect(mapStateToProps, mapDispatchToProps)(EditableCourseName);
