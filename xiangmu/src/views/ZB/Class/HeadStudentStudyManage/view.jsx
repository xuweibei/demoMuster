...
//业务接口方法引入
import { ZBstudentStudyCheckList } from '@/actions/enrolStudent';
...
class StudentStudyManageView extends React.Component {
    ...
    //检索数据
    fetch = () => {
        this.props.ZBstudentStudyCheckList(this.props.currentDataModel.studentCourseCategoryId).payload.promise.then((response) => {
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        ZBstudentStudyCheckList: bindActionCreators(ZBstudentStudyCheckList, dispatch),//查询列表接口
    };
}
//redux 组件 封装
