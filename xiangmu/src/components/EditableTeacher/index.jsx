...
import { queryTeacher } from '@/actions/live';
...
class EditablePowerPartnerTagGroup extends React.Component {
    ...
    handleSearch = (value) => {
        ...
        if (value && value.indexOf(' ')!=0) {
            ...
            this.props.queryTeacher(value).payload.promise.then((response) => {
                ...
                if (data.state === 'success') {
                    this.setState({
                        dataSource: data.data.map((a) => {
                            ...
                            return { id: `${a.userId}`, name: `${a.realName}`, mobile:a.mobile }
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        queryTeacher: bindActionCreators(queryTeacher, dispatch),
    };
}
