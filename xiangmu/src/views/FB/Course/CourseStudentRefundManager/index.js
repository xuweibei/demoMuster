...
//业务数据视图（增、删、改、查)
import CourseStudentRefundManagerView from './view'
const searchFormItemLayout = {
  labelCol: { span: 8 },
  wrapperCol: { span: 16 },
};
class CourseStudentRefundManager extends React.Component {
    ...
    fetch(params) {
        ...
        this.props.getCourseStudentRefundManagerList(condition).payload.promise.then((response) => {
                                        ...
                                        <Col span={8}>
                                            <FormItem {...searchFormItemLayout} label="申请类型">
                                                {getFieldDecorator('changeType', {
                                                    initialValue: this.state.pagingSearch.changeType,
                                                })(
                                                    <Select >
                                                        <Option value="">全部</Option>
                                                        {this.state.student_change_type.map((item, index) => {
                                                            return <Option value={item.value} key={index}>{item.title}</Option>
                                                        })}
                                                    </Select>
                                                    )}
                                        ...
                                        <Col span={8}>
                                            <FormItem {...searchFormItemLayout} label="创建人">
                                                {getFieldDecorator('createName', {
                                                    initialValue: this.state.pagingSearch.createName,
                                                })(
...
//表单组件 封装
const WrappedManage = Form.create()(CourseStudentRefundManager);
